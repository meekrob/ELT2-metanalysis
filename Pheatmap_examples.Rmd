...
```{r Display-row-and-color-annotations}
...
```{r Specifying-clustering-from-distance-matrix}
...
```{r Modify-ordering-of-the-clusters-using-clustering-callback-option}
