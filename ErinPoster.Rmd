...
pdf(file=format(Sys.time(), "plots/all-heatmap-euc-%Y-%m-%d.pdf"), 
    width=60, height=20)
hm.euclidean
dev.off()

pdf(file=format(Sys.time(), "plots/all-heatmap-cos-%Y-%m-%d.pdf"), 
    width=60, height=20)
hm.cosine
dev.off()
```
...
hc_cols_svd = callback(hc_cols, t(embryo.mx.noELT2))
# restore these two fields
hc_cols_svd$dist.method = hc_cols$dist.method
hc_cols_svd$method = hc_cols$method

system.time({
hm.embryo.elt2.binding = Heatmap(embryo.mx.noELT2, 
        clustering_method_rows = "average",
        cluster_columns = hc_cols_svd,
        heatmap_legend_param = list(title = "euclidean\nTF bound/unbound"),
        show_heatmap_legend = FALSE,
        show_row_names = FALSE, 
        show_column_names = T, 
